...
import RadarChartVisualization from '../components/onboarding/RadarChartVisualization';
import CareerSuggestion from '../components/onboarding/CareerSuggestion';
...
const Onboarding = () => {
  ...
  }, [onboardingComplete, navigate, user]);

  // Steps for the onboarding process
  const steps = [
    { title: 'Profile Information', component: <ProfileForm /> },
    { title: 'Personality Test', component: <PersonalityTest /> },
    { title: 'Your Strengths', component: <RadarChartVisualization /> },
    { title: 'Career Suggestions', component: <CareerSuggestion /> },
  ];
  ...
  return (
    <OnboardingContainer>
      <ContentWrapper>
        ...
        <button
          onClick={async () => {
            // Ensure onboarding is marked as complete before navigating
            if (!onboardingComplete) {
              try {
                // Update the onboarding_complete flag in Supabase
                ...
                // This is a fallback in case the CareerSuggestion component didn't mark it
                await saveCareerSuggestion("General Career Path");
              } catch (error) {
